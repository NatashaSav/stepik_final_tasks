...
# при ее использовании аналогичная функция ниже должна быть закоментирована
# в самой функции закоментированые строки не трогаем, так должно быть чтобы все работало
